...
abstract contract IncentiveMechanism {
     ...
     */
    function getNextAddDataCost() public view virtual returns (uint);
...
abstract contract IncentiveMechanism64 is Ownable, IncentiveMechanism {
    ...
    function handleAddData(
        ...
        int64[] memory data,
        uint64 classification
    ) public virtual returns (uint cost);
    ...
    function handleRefund(
        ...
        uint64 prediction,
        uint numClaims
    ) public virtual returns (uint refundAmount);
    ...
    function handleReport(
        ...
        uint64 prediction,
        uint numClaims
    ) public virtual returns (uint rewardAmount);
}
