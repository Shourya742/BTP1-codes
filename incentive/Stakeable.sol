...
contract Stakeable is Ownable, IncentiveMechanism {
     ...
     */
    function getNextAddDataCost() public view override returns (uint) {
...
contract Stakeable64 is IncentiveMechanism64, Stakeable {
    ...
    function handleRefund(
        ...
        uint64 prediction,
        uint /* numClaims */
    ) public override onlyOwner returns (uint refundAmount) {
    ...
    function handleReport(
        ...
        uint64 prediction,
        uint /* numClaims */
    ) public override onlyOwner returns (uint rewardAmount) {
        // Make sure deposit can be taken.
